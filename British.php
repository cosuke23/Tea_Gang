...
<br>    
  ...
  $current_url = base64_encode($url="http://localhost/htdocs/MCJ%20finals/carnation.php");
    
  $results = $mysqli->query("SELECT * FROM carnation");
    if ($results) { 
...
<?php
  $url = base64_encode($url="http://localhost/htdocs/MCJ%20finals/carnation.php");
