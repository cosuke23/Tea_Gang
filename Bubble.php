...
<div class="shopping-cart "   style="background:url('images/ft1.jpg');width:370px;height:400px'">
...
<?php
  $url = base64_encode($url="http://localhost/xampp/tea%20gang/Bubble.php?flavor=Redvelvet");
if(isset($_SESSION["products"]))
{
    ...
    echo '</ol>';
    echo '<strong>Total:'.$currency.number_format($total).'</strong>';
