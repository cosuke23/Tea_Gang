...
<br>       
  ...
  $current_url = base64_encode($url="http://localhost/htdocs/MCJ%20finals/sunflower.php");
    
  $results = $mysqli->query("SELECT * FROM sunflower");
    if ($results) { 
...
<?php
  $url = base64_encode($url="http://localhost/htdocs/MCJ%20finals/sunflower.php");
