...
<br>
      <ul class="grid cs-style-4">
        <center>
 <div style="font-size:35px; font-family:Trajan Pro; margin-left:80px; margin-top:18px; color:#FFCC66;">Lavender</div>       
   </center>
<br>       
    <?php
    //current URL of the Page. cart_update.php redirects back to this URL
  $current_url = base64_encode($url="http://localhost/htdocs/MCJ%20finals/lavander.php");
    
  $results = $mysqli->query("SELECT * FROM lavander");
    if ($results) { 
...
<?php
  $url = base64_encode($url="http://localhost/htdocs/MCJ%20finals/lavander.php");
