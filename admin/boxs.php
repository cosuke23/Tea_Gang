            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 wow fadeIn">
                        ...
                        <p>Arrangement</p>
                       <a class="btn btn-primary" rel=facebox href="addprod.php?type=boxs&types=arrangement">ADD</a> <a href="basket.php">Basket</a>|| <a href="boxs.php">Box</a> ||<a href="abouq.php">bouquet</a>||<a href="avase.php">Vase</a>||<a href="astand.php">Standing</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <tr class="danger">
                  ...
                  <th>Action</th>
                                ...
                                <?php
                                    ...
                                    $query=mysql_query("SELECT * from boxs ");
                                    $type="boxs";
                           ...
                           <td style="text-align:center;">  <a class="btn btn-primary" rel=facebox href="edit.php?id=<?php echo $row['flower_id']; ?>&type=<?php echo $type; ?>">EDIT</a> <a class="btn btn-primary" href='cancelapp.php?id=<?php echo $row['Id']; ?>'>DELETE</a></td>             </tr>
