...
<br>       
    ...
    $flavor=$_GET['flavor'];
  $current_url = base64_encode($url="http://localhost/xampp/tea%20gang/order_now.php?flavor=$flavor");
...
<?php
  $url = base64_encode($url="http://localhost/xampp/tea%20gang/order_now.php?flavor=$flavo");
