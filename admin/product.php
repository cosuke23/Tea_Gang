            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 wow fadeIn">
                       ...
                       <a class="btn btn-primary" rel=facebox href="addprod.php?type=milk_tea&&flavor=Bubble">ADD</a> <a href="product.php?flavor=<?php echo 'Bubble' ?>">Bubble</a>|| <a href="product.php?flavor=<?php echo 'Taro' ?>">Taro</a> ||<a href="product.php?flavor=<?php echo 'British' ?>">British</a>||<a href="product.php?flavor='<?php echo 'Green' ?>'">Green</a>
                    </div>
                </div>
            </div>
        </div>
