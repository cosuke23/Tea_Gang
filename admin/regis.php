...
session_start();
	...
	$password=$_POST['password'];
		...
		$query=mysql_query("select * from customers where Email=email or Username=$username ");
		$num=mysql_num_rows($query);
		if($num>=1){
			echo"<script>alert('Email/Username already in use');</script>";
			//header("location:signup.php");
		}else{
		mysql_query("insert into customers(Name, Email, Contact, Password, Username)
...
<div class="container">
        ...
        <br>
                            <input type="text" name="username" maxlength="11" placeholder="Your username..." required/>
                          </div>
              <div class="form-group">
