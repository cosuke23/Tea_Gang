                ...
                <tr class="danger">
                  ...
                  <th>Action</th>
                                ...
                                <?php
                                    ...
                                    $query=mysql_query("SELECT * from vase ");
                                    while($row=mysql_fetch_array($query)) { ?>
                                    <tr>
                                        <td> <?php echo $row['name']; ?> </td>
                                        <td> <?php echo $row['qty']; ?> </td>
                                        <td> <?php echo $row['price']; ?> </td>
                                        <td style="text-align:center;"> <a class="btn btn-primary" href='cancelapp.php?id=<?php echo $row['Id']; ?>'>ADD</a> <a class="btn btn-primary" href='cancelapp.php?id=<?php echo $row['Id']; ?>'>EDIT</a> <a class="btn btn-primary" href='cancelapp.php?id=<?php echo $row['Id']; ?>'>DELETE</a></td>
                                    </tr>
                                    <?php } ?>    
