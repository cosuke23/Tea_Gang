...
<br>  
  ...
  $current_url = base64_encode($url="http://localhost/htdocs/MCJ%20finals/bouqet.php");
    
  $results = $mysqli->query("SELECT * FROM bouqet");
    if ($results) { 
...
<?php
  $url = base64_encode($url="http://localhost/htdocs/MCJ%20finals/bouqet.php");
