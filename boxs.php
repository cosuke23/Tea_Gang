...
<br>  
  ...
  $current_url = base64_encode($url="http://localhost/htdocs/MCJ%20finals/boxs.php");
    
  $results = $mysqli->query("SELECT * FROM boxs");
    if ($results) { 
...
<?php
  $url = base64_encode($url="http://localhost/htdocs/MCJ%20finals/boxs.php");
