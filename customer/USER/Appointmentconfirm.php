...
<p align="center"><a href="Appointmentprint.php"><b>View Print</b></a></p>
</form>
<br>
</div>
</div>
...
if(isset($_POST['submit']))
	...
	$eventtype1=$_POST['event1'];
        $contact1=$_POST['contact1'];
	$email1=$_POST['email1'];
	$date1=$_POST['sched1'];
	$fullname1=$_POST['fname1'];
...
if($fullname!="" && $date!="" && $contact!="")
					
				{
							
	
							$sql2 = mysql_query("SELECT *	 FROM tbl_appointment where date='$date' and oras='$time' ");
						...
						if ($cnt2 > 0) 
							...
							$sql3 =mysql_query( "INSERT INTO tbl_appointment (date,oras,event_type,fullname,contact,email,status,query_id)
							VALUES ('$date','$time','$eventtype','$fullname',$contact,'$email','pending','$session_id')");

								echo "<script>alert('Appointment has been made, Thank you!');</script>";
							}
				}
   else{echo "<script>alert('Please fill-in the required information!');</script>";}
 /*  if($fullname1!="" && $date1!="" && $contact1!="" ){
	
					$sql4 = "INSERT INTO tbl_appointment (date,event_type,fullname,contact,email)
					VALUES ('$date1','$eventtype1','$fullname1',$contact1,'$email1')";
