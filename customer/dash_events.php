            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 wow fadeIn">
                        ...
                        <a class="btn btn-primary" href="dash_customized.php?type=basket&types=arrangement">Customized</a><a class="btn btn-primary" href="dashboard.php?type=basket&types=arrangement">Arrangements</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <tr class="danger">
                  ...
                  <th>Action</th>
                                ...
                                <?php
                                    ...
                                    $query=mysql_query("SELECT * from temp where id = '".$_SESSION['id']."' and type='events'  order by price DESC ");
...
$qty=$row['qty'];
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center;"> <a class="btn btn-primary" href='cancelapp.php?cnt=<?php echo $row['cnt']; ?>'>Cancel</a> </td>
                                    </tr>
                                    <?php } ?>    
