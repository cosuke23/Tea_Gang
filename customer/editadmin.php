...
if(isset($_POST['subpic'])){
	 ...
	 move_uploaded_file($_FILES['ppic']['tmp_name'],"ProfileImg/".$_FILES['ppic']);
	
               
	 	    $q = mysql_query("UPDATE admin SET img = '".$_FILES['ppic']['name']."' WHERE id='".$id."'")or die(mysql_error());
			mysql_query($q);
...
$contact = mysql_real_escape_string($_POST['Contact']);
	...
	$sql_insert=mysql_query("UPDATE admin SET Username='$uname', Lname='$lname', Name='$fname',Email='$email', Name='$fname',  Contact='$contact' WHERE id='$pid'")or die(mysql_error());
