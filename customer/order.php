...
$result2 = mysql_query("SELECT * FROM flowers WHERE flower_id='$ids'");
while($row2 = mysql_fetch_array($result2))
	...
	$name=$row2['name'];
  $img=$row2['img'];
	echo '<span><img src="assets/img/slider/flower2/'.$row2['img'].'" alt="Wall-E" title="'.$_SESSION['name'].'" /></span><br>';
