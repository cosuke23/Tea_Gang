...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>MO</b>SH</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>MSCO</b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            	  <?php
include'db.php';
               $query= mysql_query("select * from students where id = '$session_id'")or die(mysql_error());
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php echo $row['fname']." ".$row['lname'];  ?> - Web Developer
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/layout/top-nav.html"><i class="fa fa-circle-o"></i> Message</a></li>
            <li><a href="pages/layout/boxed.html"><i class="fa fa-circle-o"></i> Announcement</a></li>
          </ul>
        </li>
        <li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Dashboard
        <small><?php echo $row['club']." ".$row['status'];  ?></small>
      </h1>
      <ol class="breadcrumb">
...
<form id="submitform" action="edit.php" method="post" enctype="multipart/form-data" name="submitform" >
  <center>
                          ...
                          <label>Student ID</label>
                            ...
                            <input class="input-huge"  type="text" name="sid" value="<?php echo $club ?>"  required />
                          ...
                          <label>First Name</label>
                            ...
                            <input class="input-huge" id="focusedInput" type="text" name="name" value="<?php echo $club ?>"  required />
                          ...
                          <br>
                            ...
                            <input type="password" maxlength="11" name="pass"  placeholder="Password..." />
                         
<br>
                            <label>Confirm Password</label>
                            <br>

                            <input type="password" name="cpass" maxlength="11" placeholder="Confirm Password..." />
                         <br>
                         <br>
                   <input type="hidden" name="clubs" maxlength="11" value="<?php echo $club ?>" />
