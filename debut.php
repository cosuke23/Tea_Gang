...
<br>
 ...
 <div style="font-size:35px; font-family:Trajan Pro; margin-left:80px; margin-top:18px; color:#FFCC66;">Debut</div>       
   </center>
<br>       
    <?php
    //current URL of the Page. cart_update.php redirects back to this URL
  $current_url = base64_encode($url="http://localhost/htdocs/MCJ%20finals/debut.php");
    
  $results = $mysqli->query("SELECT * FROM debut");
    if ($results) { 
...
<?php
  $url = base64_encode($url="http://localhost/htdocs/MCJ%20finals/debut.php");
