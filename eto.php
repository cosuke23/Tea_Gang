...
<!--Take a look -->
    ...
    <body style="background:url('img/floral.png') center ">
        ...
        <div class="slider-container"  style="background:url('images/bg2.png')">
                    ...
                    <div class="col-sm-10 col-sm-offset-1 slider">
                        <div class="flexslider">
                            <ul class="slides"> 
                            <li data-thumb="assets/img/slider/f1/f1.jpg">
                                    <img src="assets/img/slider/f1/f1.jpg">
                                </li>
                              <li data-thumb="assets/img/slider/f1/f2.jpg">
                                    <img src="assets/img/slider/f1/f2.jpg">
                                </li>
                              <li data-thumb="assets/img/slider/f1/f3.png">
                                    <img src="assets/img/slider/f1/f3.png">
                                </li>
                              <li data-thumb="assets/img/slider/f1/f4.png">
...
while($row2 = mysql_fetch_array($result2))
  ...
  <figure>
		                   ...
		                   <figcaption>
                            ...
                            <a class="big-link-1" href="services.php">VIEW</a>
                            </figcaption>
                    </figure>
		                </div>
                          <?php
