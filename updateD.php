...
if(isset($_POST["type"]) && $_POST["type"]=='add')
{
	...
	$product_qty 	= filter_var($_POST["qty"], FILTER_SANITIZE_STRING); //product code
	...
	$results = $mysqli->query("SELECT name,price,img FROM milk_tea WHERE tea_id='$product_code'   LIMIT 1");
