...
<br>        
  ...
  $current_url = base64_encode($url="http://localhost/htdocs/MCJ%20finals/vase.php");
    
  $results = $mysqli->query("SELECT * FROM vase");
    if ($results) { 
...
<?php
  $url = base64_encode($url="http://localhost/htdocs/MCJ%20finals/vase.php");
