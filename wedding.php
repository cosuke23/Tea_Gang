...
<br>       
  ...
  $current_url = base64_encode($url="http://localhost/htdocs/MCJ%20finals/wedding.php");
    
  $results = $mysqli->query("SELECT * FROM wedding");
    if ($results) { 
...
<?php
  $url = base64_encode($url="http://localhost/htdocs/MCJ%20finals/wedding.php");
